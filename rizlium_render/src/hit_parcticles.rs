...
impl Plugin for HitParticlePlugin {
    fn build(&self, app: &mut App) {
        ...
        load_internal_asset!(app, BUILTIN_HIT_PARTICLE, "../assets/particle.json", |a, _|serde_json::from_str(a).expect("Bad effect asset"));
...
fn spawn_particle_system(mut commands: Commands, notes: Query<(&ChartNoteId, &LatestParticleTime)>) {
